...
nnmodel = NNModel(config={"input_size": 768, "embedding_size": 512, "hidden_size": 512, "output_size": 1, "n_layers": 2}).to("cuda")
...
X_train, X_test, Y_train, Y_test = sklearn.model_selection.train_test_split(
    data[args.smilescol], data["label_scaled"], test_size=args.testprop, random_state=42)
