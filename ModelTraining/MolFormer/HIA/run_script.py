...
data_pwd = '/lus/eagle/projects/datascience/avasan/PharmacoKinetics/Data/admet_open_data/admet_labelled_data/'
data_path: Path = Path(f"{data_pwd}/PPB/data.csv")
data = pd.read_csv(data_path)

# split data
X_train, X_test = sklearn.model_selection.train_test_split(data["SMILES"], test_size=0.2, random_state=42)
Y_train, Y_test = sklearn.model_selection.train_test_split(data["label"], test_size=0.2, random_state=42)
