...
#PBS -A datascience 
#PBS -o logs/stask_sweep_ll_test2.OU
#PBS -e logs/stask_sweep_ll_test2.ER
...
CUDA_VISIBLE_DEVICES=0 python run_script_lv_multi_sweep.py -d single_data -s SMILES -l EPACategoryIndex -t 0.2 -E 50 &
