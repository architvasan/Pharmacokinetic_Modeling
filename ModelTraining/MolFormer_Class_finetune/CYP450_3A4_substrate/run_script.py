...
def inference_test_set(epoch_index, criterion):
    ...
    for batch in test_dataloader:
        ...
        with open('debug.txt', w) as debug:
            debug.write(y_regression_values)
...
for epoch in (range(args.epochs)):
    ...
    for batch in test_dataloader:
        ...
        # print("Y REG VALS ")
        # print(y_regression_values)
        with open('/lus/eagle/projects/datascience/lvairus/Pharmacokinetic_Modeling/ModelTraining/MolFormer_Class_finetune/CYP450_3A4_substrate/debug.txt', w) as debug:
            debug.write(y_regression_values)
        break
